...
namespace NzbDrone.Core.Tv
{
    public interface IEpisodeService
    {
        ...
        void SetWatched(IEnumerable<int> ids, bool watched);
        ...
        void SetEpisodeWatchedBySeason(int seriesId, int seasonNumber, bool watched);
    }
                                  ...
                                  IHandleAsync<SeriesDeletedEvent>
    {
        ...
        public void SetWatched(IEnumerable<int> ids, bool watched)
        {
            _episodeRepository.SetMonitored(ids, watched);
        }
        ...
        public void SetEpisodeWatchedBySeason(int seriesId, int seasonNumber, bool watched)
        {
            _episodeRepository.SetWatchedBySeason(seriesId, seasonNumber, watched);
        }
